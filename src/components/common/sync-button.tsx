...
import { CloudOff, CloudDownload, Cloud, CloudAlert, CloudCogIcon } from 'lucide-react-native';
...
export function SyncButton({ className, onSyncComplete }: SyncButtonProps) {
  const { isSyncing, lastSyncTime, pendingChangesCount, syncError, syncNotes, loadSyncStatus } = useSyncStore();
  ...
  return (
    ...
    >
      <HStack space="xs" className="items-center">
        ...
        {pendingChangesCount === 0 && lastSyncTime && !isSyncing && !syncError && (
