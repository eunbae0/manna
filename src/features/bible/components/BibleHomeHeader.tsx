...
import { ChevronDown, ChevronLeft, ChevronRight, Info, Search, Settings, X } from 'lucide-react-native';
        ...
        <HStack className="justify-between items-center pt-1 pb-2 pl-5 pr-3 border-b border-gray-100 dark:border-gray-800">
          <HStack space="md" className="items-center">
            ...
            <AnimatedPressable onPress={handleOpen}>
              <Text weight="semi-bold" className="px-2 py-1 rounded-lg bg-primary-100 border border-primary-200/40 text-primary-800/70">개역한글</Text>
            </AnimatedPressable>
          </HStack>
          <HStack>
      ...
      <BottomSheetContainer>
        <VStack className="px-5 pt-5 pb-12">
          <VStack space="2xl">
            ...
            <Text size="xl" className="text-typography-900">성경전서 개역한글판(Korean Revised Version - KRV, 1961)에 대한 저작권은 대한성서공회에 있습니다.</Text>
            {/* <TextWithLinks text="https://www.bskorea.or.kr/bbs/board.php?bo_table=copyright_faq&wr_id=5" /> */}
          </VStack>

          <Divider size="sm" className="my-6" />
          <VStack space="md">
            <Text size="xl" weight="semi-bold" className="text-typography-900">자주 묻는 질문</Text>
            <VStack space="xs">
              <Text size="lg" weight="medium" className='text-typography-900'>Q. 왜 개역개정 성경이 아닌가요?</Text>
              <Text size="lg" className="text-typography-600">- 개역개정 성경은 저작권 문제로 아직 제공되지 않고 있어요. 대한성서공회와 협의하여 빠른 시일 내에 제공할 수 있도록 노력하겠습니다.</Text>
            </VStack>
          </VStack>
        </VStack>
      </BottomSheetContainer>
