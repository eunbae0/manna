...
export default function NoticeScreen() {
	...
	const [expandedNotice, setExpandedNotice] = useState<string | null>(
		id || null,
	);
						...
						<HStack className="items-center justify-between">
							<HStack space="sm" className="items-center flex-1">
								...
								<Text
									size="xl"
									weight="semi-bold"
									className={cn('flex-1', item.isPinned && 'text-primary-600')}
								>
									{item.title}
								</Text>
							</HStack>
		...
		return (
			<SafeAreaView className="flex-1 bg-background-50">
				...
				<VStack className="flex-1 items-center justify-center p-4">
					<Text size="lg" weight="bold" className="text-error-500 mb-2">
						공지사항을 불러올 수 없어요
					</Text>
